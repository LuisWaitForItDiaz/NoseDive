...
public class HeartBalloon extends Balloon{
    ...
    public HeartBalloon(GameState game, ResourceManager res) {
        super(game, res);
        ...
        try {
            ...
            sprite = new SpriteSheet(new Image("res/heartBalloon.png").getScaledCopy(1), 196, 196);
    ...
    public boolean pop() {
        hitBox = null;
        try {
            spriteDestroy = new SpriteSheet(new Image("res/heartBalloonPop.png").getScaledCopy(1), 196, 196);
